...
- Bug fix:
  ...
  validated up front with a clear error message
  ([\#7](https://github.com/beckyfisher/FSSgam_package/issues/7)).
- Added a test-coverage GitHub Actions workflow
  ...
  ([\#3](https://github.com/beckyfisher/FSSgam_package/issues/3)).
