...
#' not suitable for extremely large models sets, as these will cause issues with memory. This method may be superseded in future versions of FSSgam, so for any new project please use the second method.
#'
...
#' This method is useful for large model sets, because it allows the model set to be interrogated before fitting and also optionally allows model fit data to not be saved, thus alleviating memory issues.
#'
