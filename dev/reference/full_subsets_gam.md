...
- logLik.fn:
  ...
  log-likelihood value, or NULL (the default). Passed to fit_model_set;
  see ?fit_model_set for what it does and for the two cases it is
  supplied for automatically.
